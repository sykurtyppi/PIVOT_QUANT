...
CALIB_THRESHOLD_MIN_UTILITY_SCORE="${CALIB_REFIT_THRESHOLD_MIN_UTILITY_SCORE:-${RF_THRESHOLD_MIN_UTILITY_SCORE:-0.0}}"
...
CALIB_ARGS=(
  ...
  --threshold-min-utility-score "${CALIB_THRESHOLD_MIN_UTILITY_SCORE}"
