...
LABEL_SESSION_ROUTINE="com.pivotquant.session_routine"
...
TARGET_SESSION_ROUTINE="gui/${UID_NUM}/${LABEL_SESSION_ROUTINE}"
...
check_launch_agent "${TARGET_SESSION_ROUTINE}" "${LABEL_SESSION_ROUTINE}"
